...
export default function Example() {
  return (
    <Popover className='relative bg-primary bg-opacity-75'>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-primary inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                    )}
                  >
                    <span>More</span>
                    <ChevronDownIcon
                  ...
                  >
                    <Popover.Panel className='absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0'>
                      <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden'>
                        <div className='relative grid gap-6 bg-theme-bg px-5 py-6 sm:gap-8 sm:p-8'>
                          {resources.map((item) => (
                            <a
                              key={item.name}
                              href={item.href}
                              className='-m-3 p-3 flex items-start rounded-lg hover:bg-theme-bg'
                            >
                              <item.icon
                        ...
                        <div className='px-5 py-5 bg-theme-bg sm:px-8 sm:py-8'>
                          <div>
                ...
                <nav className='grid gap-y-8'>
                  {solutions.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className='-m-3 p-3 flex items-center rounded-md hover:bg-theme-bg'
                    >
                      <item.icon
                        className='flex-shrink-0 h-6 w-6 text-indigo-600'
                        aria-hidden='true'
